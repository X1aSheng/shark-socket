...
| Validation | Fast full test + vet, optional race | `go run scripts/run_tests.go -mode vet` |
| Deploy | Static deploy tests plus optional Docker/Kubectl/Helm rendering | `go run scripts/run_tests.go -mode deploy` |
